...
const surveyIntelligenceRoutes = require('./routes/surveyIntelligence');
...
app.use('/api/survey-intelligence', surveyIntelligenceRoutes);  // Survey Intelligence data routes
